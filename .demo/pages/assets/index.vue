  ...
  <TairoContentWrapper>
    ...
    <TairoTable shape="curved">
      <template #header>
        ...
        <TairoTableHeading uppercase>Статус</TairoTableHeading>
        <TairoTableHeading uppercase>Склад</TairoTableHeading>
        <TairoTableHeading uppercase>Создал</TairoTableHeading>
